...
public class CH04_MyMultipleFaces extends Application{
	...
	public void start(Stage primaryStage)throws Exception
	{
		...
		for(i=0; i<9; i++) {
			...
			gc.strokeArc(X_MOUTH0 + xOffset,  Y_MOUTH0 + yOffset,  MOUTH_WIDTH,  MOUTH_HEIGHT0 + 3*i*5/9+1, MOUTH_START_ANGLE, MOUTH_EXTENT_ANGLE, ArcType.OPEN);
		...
		gc.setStroke(Color.RED);
		gc.strokeArc(X_MOUTH0 + xOffset, Y_MOUTH0+ yOffset, MOUTH_WIDTH, MOUTH_HEIGHT0 + 3 *(i-6), MOUTH_START_ANGLE, MOUTH_EXTENT_ANGLE, ArcType.OPEN);
		gc.setStroke(Color.BLACK);
